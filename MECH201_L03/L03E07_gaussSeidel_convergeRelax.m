function L03E07_gaussSeidel_convergeRelax
...
%% ---
disp('___________________________________________________________________')
disp('Using a custom Gauss-Seidel script with relaxation factor (lambda) varying from 0.1 to 100 in steos of 0.1')
disp('------')
