function L05E17_quadraticSplinesInterpolation
...
disp('x = 5 lies within the range of equation f2(4.5 <= x <= 7)')
f2Atx5 = C(4)*(5^2) + C(5)*5 + C(6);
disp(['So f2(x) @ (x = 5) = ', num2str(f2Atx5)])
disp('___________________________________________________________________')
