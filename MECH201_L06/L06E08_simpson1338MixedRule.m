function L06E08_simpson1338MixedRule
...
% % Applying Simpson's 3/8 Rule to the second array
s38RArea = ((3*stepSize)/8) * (sum(f(x38(1:3:end-3))) +  3*sum(f(x38(2:3:end-2))) + 3*sum(f(x38(3:3:end-1))) + sum(f(x38(4:3:end))));
